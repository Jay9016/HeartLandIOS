...
class DragonClingonGameSheet_1_VC: UIViewController {
  ...
  //  @IBOutlet weak var stepnoLbl: UILabel!
    ...
    override func viewDidLoad() {
        ...
        //self.navigationController?.navigationBar.titleTextAttributes = [NSAttributedStringKey.font: UIFont(name: "HelveticaNeue", size: 16)!]
...
//        UINavigationBar.appearance().titleTextAttributes = attributes
        //stepnoLbl.adjustsFontSizeToFitWidth = true
